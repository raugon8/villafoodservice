...
class _login_screen_state extends State<login_screen> {
  ...
  void ejecutar_login() async {
    ...
    try {
      ...
      Provider.of<auth_provider>(
        context,
        listen: false,
      ).set_user(u.usuario_id, roles, token: token);
  ...
  Widget build(BuildContext context) {
          ...
          children: [
            ...
            TextButton(
              onPressed: () => Navigator.push(
                context,
                MaterialPageRoute(builder: (c) => const register_screen()),
              ),
              child: Text(
                localizations.login_registro,
    ...
    return Scaffold(
      appBar: AppBar(
        title: isDesktop
            ? const Text('VillaFoodService')
            : Text(localizations.login_titulo),
        centerTitle: !isDesktop,
        actions: [
          IconButton(
            icon: Icon(
              theme_prov.is_dark_mode ? Icons.light_mode : Icons.dark_mode,
            ),
